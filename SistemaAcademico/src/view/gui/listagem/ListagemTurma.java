...
public class ListagemTurma extends javax.swing.JFrame {
    ...
    public ListagemTurma(MenuPrincipal menuPrincipal, EntityManager em){
        this();
    ...
    private void initComponents() {
        ...
        titulo.setText("Listagem de Turmas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListagemTurma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListagemTurma().setVisible(true);
            }
        });
    }
