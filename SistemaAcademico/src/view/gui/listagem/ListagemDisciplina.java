...
public class ListagemDisciplina extends javax.swing.JFrame {

    private MenuPrincipal menuPrincipal;
    private EntityManager em;
    private DisciplinaDaoImpl daoDisciplina = DisciplinaDaoImpl.getInstancia();

    public ListagemDisciplina() {
        initComponents();
    }

    public ListagemDisciplina(MenuPrincipal menuPrincipal, EntityManager em){
        this();
    ...
    private void initComponents() {
        ...
        titulo.setText("Listagem de Disciplinas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListagemDisciplina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListagemDisciplina().setVisible(true);
            }
        });
    }
