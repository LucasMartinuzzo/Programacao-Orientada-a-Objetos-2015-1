...
public class ListagemAtividade extends javax.swing.JFrame {

    private MenuPrincipal menuPrincipal;
    private EntityManager em;
    private AtividadeDaoImpl daoAtividade = AtividadeDaoImpl.getInstancia();
    
    public ListagemAtividade() {
        initComponents();
    }

    public ListagemAtividade(MenuPrincipal menuPrincipal, EntityManager em){
        this();
    ...
    private void initComponents() {
        ...
        titulo.setText("Listagem de Atividades");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListagemAtividade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListagemAtividade().setVisible(true);
            }
        });
    }
